...
**Project:** joan-kernelsu
**Generated:** 2026-08-22 20:08:01
...
|------|-----|--------------|
| OLED | `#07080A` | `--oled` |
| Chassis | `#14171C` | `--chassis` |
| Aluminum CTA | `#C9CDD4` | `--aluminum` |
| Ticker cyan | `#4FD1C5` | `--cyan` |
| Text | `#EEF1F4` | `--text` |
| Dim | `#8A9099` | `--dim` |
| Line | `#2A2F38` | `--line` |
| Danger | `#FF8A80` | `--danger` |

**Color Notes:** OLED chassis + aluminum CTA + Lineage-adjacent cyan ticker. Gold was dropped — it read as a generic GitHub-star template, not a V30.
...
- **Mono:** IBM Plex Mono
- **Mood:** 2017 flagship, second-screen ticker, kernel dump, aluminum, OLED
- **Google Fonts:** Archivo Narrow + IBM Plex Sans + IBM Plex Mono
